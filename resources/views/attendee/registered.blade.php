{{-- filepath: resources/views/attendee/registered.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>My Registered Events | Event Management</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="bg-white rounded-4 shadow p-4 mb-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped align-middle">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">No registered events found.</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
