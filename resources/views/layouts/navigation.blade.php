...
@endif
    ...
    @elseif(auth()->user()->role === 'attendee')
        <x-nav-link :href="route('attendee.dashboard')" :active="request()->routeIs('attendee.dashboard')">
            {{ __('Dashboard') }}
        </x-nav-link>
    @endif
@endif
    ...
    @elseif(auth()->user()->role === 'attendee')
        <x-responsive-nav-link :href="route('attendee.dashboard')" :active="request()->routeIs('attendee.dashboard')">
            {{ __('Dashboard') }}
        </x-responsive-nav-link>
    @endif
@endif
