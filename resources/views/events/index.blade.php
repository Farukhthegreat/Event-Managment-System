            ...
            <div class="col-md-3 mb-4">
                <div class="sidebar">
                    <nav class="nav flex-column">
                        <a class="nav-link mb-2 {{ request()->is('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}">
                            <i class="bi bi-speedometer2 me-2"></i> Dashboard
                        </a>
                        <a class="nav-link mb-2 {{ request()->is('events') ? 'active' : '' }}" href="{{ route('events.index') }}">
                            <i class="bi bi-calendar-event me-2"></i> My Events
                        </a>
                        <a class="nav-link mb-2 {{ request()->is('events/create') ? 'active' : '' }}" href="{{ route('events.create') }}">
                            <i class="bi bi-plus-circle me-2"></i> Create Event
                        </a>
                        
                        {{-- <a class="nav-link mb-2 {{ request()->is('attendees*') ? 'active' : '' }}" href="{{ route('attendees.index') }}">
                            <i class="bi bi-people me-2"></i> Attendees
                        </a> --}}
                        <a class="nav-link mb-2 {{ request()->is('profile') ? 'active' : '' }}" href="{{ route('profile.show') }}">
