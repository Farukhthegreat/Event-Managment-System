{{-- filepath: resources/views/events/attendee_index.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Browse Events | Event Management</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="bg-white rounded-4 shadow p-4 mb-4">
                    <h3 class="mb-4">All Upcoming Events</h3>
                        ...
                        <table class="table table-striped align-middle">
                            ...
                            @forelse($events as $event)
                                <tr>
                                    ...
                                    <td>{{ $event->price }}</td>
                                    <td>
                                        <a href="{{ route('events.attendee_show', $event->id) }}" class="btn btn-primary btn-sm">View</a>
                                        <form action="{{ route('events.register', $event->id) }}" method="POST" style="display:inline;">
                                            @csrf
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted">No upcoming events found.</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
